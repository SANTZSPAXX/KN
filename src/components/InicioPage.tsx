...
export default function InicioPage({ activeTab, setActiveTab }: InicioPageProps) {
  // Collapsible Sections Toggles - Open status by default to maximize conversion of visitors
    ...
    >
      ...
      <div className="max-w-4xl mx-auto space-y-6 text-left">
        <div className="text-center space-y-2">
          <span className="text-[10px] font-mono font-bold text-indigo-400 uppercase tracking-widest block">ACELERE SEU BRIEFING</span>
          <h2 className="text-xl md:text-3xl font-extrabold text-white tracking-tight">Blueprints de Software Desenvolvidos pela KoreNexus</h2>
          <p className="text-xs text-slate-400">Selecione um dos nossos escopos pré-arquitetados abaixo para auto-preencher o gerador de Planos de Ação instantaneamente e ver o resultado sênior.</p>
        </div>
