      ...
      {step === "gate" && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch max-w-4xl mx-auto animate-fade-in" id="funnel-lead-step">
          ...
          <div className="lg:col-span-7 bg-[#0b1220] border border-gray-800 p-6 sm:p-8 rounded-3xl flex flex-col justify-center space-y-5">
            ...
            <form onSubmit={handleLeadSubmit} className="space-y-4 font-sans" data-webmcp-tool="submit-erp-diagnostico" data-webmcp-description="Envia as respostas do diagnóstico de eficiência do ERP para obter roteiro de soluções e ROI." data-webmcp-schema='{"name":{"type":"string","required":true,"description":"Nome do Gestor/Diretor"},"email":{"type":"string","required":true,"description":"E-mail corporativo"},"whatsapp":{"type":"string","required":true,"description":"WhatsApp de contato"}}'>
              <div className="space-y-1">
                ...
                <input
                  ...
                  data-webmcp-param="gestor-nome"
                  data-webmcp-description="Nome completo do Diretor ou Gestor que está rodando a auditoria"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-[#070b14] border border-gray-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none rounded-xl text-xs text-white"
                    data-webmcp-param="email-corporativo"
                    data-webmcp-description="E-mail profissional para receber o arquivo PDF de diagnóstico"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-[#070b14] border border-gray-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none rounded-xl text-xs text-white"
                    data-webmcp-param="whatsapp-contato"
                    data-webmcp-description="Número do WhatsApp com DDD para contato rápido sobre o ROI calculado"
                  />
                </div>
              </div>
