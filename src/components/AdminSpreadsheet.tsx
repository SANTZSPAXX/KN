                    ...
                    return filteredRows.map((row: any, rowIndex) => {
                      ...
                      return (
                        <tr key={`${row.id || "row"}-${rowIndex}`} className="border-b border-gray-850 hover:bg-gray-800/10 text-slate-200 group">
                              ...
                              >
                                {isEditing ? (
                                  <input
                                    ...
                                    autoFocus
                                    className="w-full h-full p-2 bg-[#05080E] text-white border border-blue-500/50 outline-none focus:ring-1 focus:ring-blue-500 rounded-lg text-xs font-sans font-normal"
                                    onKeyDown={(e) => {
                                        if (e.key === "Enter") {
                                          setEditingCell(null);
                                        }
                                  ...
                                  <div className="p-2 pr-6 truncate min-h-[32px] flex items-center relative group" title="Clique duplo ou simples para editar">
                                    {cellValue !== "" ? (
                                      cellValue
                                    ) : (
                                    ...
                                    {!isId && (
                                      <div className="absolute right-1.5 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition duration-150 pointer-events-none text-slate-500">
                          ...
                          <td className="p-2 text-center bg-[#111622]/10">
                            <button
                              onClick={() => handleDeleteRow(computedIndex)}
                              className="p-1 px-2 text-rose-500 hover:text-white hover:bg-rose-555/20 hover:bg-rose-600/20 rounded transition opacity-40 group-hover:opacity-100 cursor-pointer"
                              title="Remover linha"
