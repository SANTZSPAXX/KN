...
import { Save, Plus, Trash2, Download, Send, CheckCircle2, AlertCircle, Github, Eye, EyeOff, Key, Settings, Database, Lock, ShieldCheck, RefreshCw, Layers, Activity, Globe, Gauge, Sparkles } from "lucide-react";
    ...
    try {
      ...
      if (result.success) {
        ...
        try {
          ...
          // Valid Firestore sync for defined core collections
          ...
          console.warn("Alterações salvas localmente, mas a sincronização do Firebase Firestore falhou:", firebaseErr);
        }
