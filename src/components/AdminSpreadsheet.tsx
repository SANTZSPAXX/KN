...
export default function AdminSpreadsheet({ data, onUpdateData, onRefresh, adminEmail }: AdminSpreadsheetProps) {
  ...
  useEffect(() => {
    if (activeTab !== "configuracoes" && activeTab !== "seo-metricas") {
  ...
  const renderStatsPanel = () => {
    if (activeTab === "configuracoes" || activeTab === "seo-metricas") return null;
  ...
  const handleCloneRow = (rowIndex: number) => {
    if (activeTab === "configuracoes" || activeTab === "seo-metricas") return;
