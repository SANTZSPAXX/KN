    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      {showText && (
        <div className="flex flex-col select-none">
          ...
          <div className="flex items-center gap-1.5 w-full my-1 opacity-80">
          ...
          <span className={`font-sans tracking-widest text-[#94a3b8] uppercase font-bold leading-tight ${currentSize.sub}`}>
