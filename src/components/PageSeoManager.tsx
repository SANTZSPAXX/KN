...
export default function PageSeoManager({
  ...
  const resolvedSeoData = () => {
    ...
    let desc = "Acelere o faturamento da sua empresa em Jundiaí com a KoreNexus: desenvolvimento de sistemas e softwares sob medida, ERP personalizado, WMS inteligente e automações robustas com inteligência artificial. Agende um diagnóstico gratuito!";
    let h1 = "Pare de perder margem: Sistemas sob Medida, SaaS e WMS que automatizam sua empresa de ponta a ponta";
    let h2List = [
    ...
    if (activeTab === "ferramentas") {
      if (selectedTool) {
        title = `${selectedTool.nome} Online: Otimize Processos Gratuitamente | KoreNexus`;
        desc = `Aumente a produtividade da sua equipe com a ferramenta online ${selectedTool.nome}. Faça validações rápidas de XML, auditorias de dados Sefaz e elimine gargalos burocráticos.`;
        ...
        if (subTab === "fiscais") {
          title = "Formatadores e Validadores Fiscais Sefaz Online | KoreNexus";
          desc = "Valide notas fiscais XML de forma instantânea e gratuita. Corrija erros de emissão, calcule margens de impostos e simplifique o faturamento com nossa ferramenta fiscal.";
          ...
          title = "Simulador Sandbox e Ferramentas para Desenvolvedores | KoreNexus";
          desc = "Acelere suas integrações. Decodifique tokens JWT, teste expressões regulares e valide payloads de faturamento em um ambiente seguro de testes.";
          ...
          title = "50 Ferramentas Gratuitas de Produtividade e SEO | KoreNexus";
          desc = "Ganhe tempo no dia a dia: dezenas de utilitários rápidos para gerar contratos, otimizar SEO de conteúdo, formatar dados e otimizar sua rotina de trabalho em um só lugar.";
          ...
          title = "Gerador de QR Code e Pix Dinâmico Online | KoreNexus";
          desc = "Crie códigos QR de alta densidade e chaves Pix em conformidade com o Banco Central para automatizar as cobranças da sua empresa de maneira simples.";
      ...
      title = "Fábrica de Chatbots WhatsApp e Atendimento IA | KoreNexus";
      desc = "Reduza o tempo de atendimento da sua empresa em até 80%. Integre robôs inteligentes no WhatsApp e automatize fluxos de vendas e suporte ao cliente 24/7.";
      ...
      title = "Portaria Inteligente e Controle de Acesso Veicular | KoreNexus";
      desc = "Aumente a segurança e a agilidade da sua indústria. Controle pátios com leitura de placas por OCR, reconhecimento facial e gerenciamento de frotas integrado.";
      ...
      title = "WMS Inteligente, Estoque e Automação Logística | KoreNexus";
      desc = "Controle seu estoque de ponta a ponta. Nosso sistema WMS integra o faturamento fiscal síncrono com a movimentação real de materiais em menos de 2 segundos.";
      ...
      title = "Auditoria de ERP e Diagnóstico de Vazamento de Margem | KoreNexus";
      desc = "Onde sua empresa está perdendo dinheiro? Identifique em minutos os gargalos operacionais e os erros de faturamento que estão corroendo sua lucratividade.";
      ...
      title = "Desenvolvimento de Sistemas sob Medida e Tecnologia | KoreNexus";
      desc = "Conheça a KoreNexus: criamos sistemas robustos e de alto desempenho para transformar a produtividade e otimizar a infraestrutura operacional de empresas paulistas.";
      ...
      title = "Cursos Práticos de Programação e Integração Sefaz | KoreNexus";
      desc = "Aprenda desenvolvimento de sistemas corporativos, microsserviços integrados a APIs e faturamento fiscal na prática com nossa metodologia de engenharia.";
