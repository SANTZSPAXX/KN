...
export default function SeoMetricasView({ data, onRefresh, adminEmail }: SeoMetricasViewProps) {
  ...
  // Performance metric states to address "Corrija First Contentful Paint..." and "Recursos Bloqueantes de Renderização"
  ...
  const perfMode = (deferJs && inlineCss && asyncFonts && longCache) ? "optimized" : "legacy";
  ...
  // FCP = 7.7s, LCP = 12.4s, TBT = 560ms, CLS = 0.688, SI = 8.2s, Score = 34
  // All optimized:
        ...
        <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#0A0D14]/73 border border-slate-800 p-6 rounded-3xl space-y-4 shadow-xl flex flex-col justify-between">
            <div className="space-y-3.5">
              ...
              {perfMode === 'legacy' ? (
                <div className="p-3 bg-rose-950/20 border border-rose-500/20 rounded-xl text-[11px] text-rose-300 leading-normal">
                  ⚠️ <strong>Aviso de Rede</strong>: FCP de {fcpStr}, LCP de {lcpStr} e alto índice de atraso devido a recursos bloqueantes. Isso aumenta severamente a taxa de rejeição em Jundiaí e região. Corrija nos controles abaixo.
                </div>
              ) : (
                <div className="p-3 bg-emerald-950/20 border border-emerald-500/30 rounded-xl text-[11px] text-emerald-300 leading-normal">
                  🟢 <strong>Totalmente Otimizado</strong>: Através de minificação CSS/JS, compressão gzip redundante e imagens responsivas com caching CDN instantâneo, todas as métricas residem na zona verde excelente.
                </div>
              )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 font-mono text-[10px] text-gray-300">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-slate-450 text-[9px] uppercase font-bold">
                    ...
                    <span className={scoreVal >= 90 ? 'text-emerald-400' : scoreVal >= 50 ? 'text-amber-400' : 'text-rose-400 font-bold'}>
                      {fcpStr}
                    </span>
                  </div>
              ...
              <div className="pt-4 border-t border-slate-850 space-y-3.5">
                <span className="text-[10px] font-mono font-extrabold text-indigo-400 block uppercase tracking-wider">
                  🛠️ Gestão de Recursos Bloqueantes (Critical Render Path)
                </span>
                ...
                <div className="space-y-2 font-sans text-xs">
                  ...
                  <label className="flex items-start gap-2.5 p-2.5 bg-[#05080E]/40 border border-slate-850/80 rounded-xl cursor-pointer hover:bg-slate-900/50 transition">
                    <input 
                      ...
                      className="mt-0.5 h-3.5 w-3.5 accent-blue-500 rounded text-blue-600 bg-slate-950 border-slate-800"
                    />
                    <div className="text-[11px] leading-snug">
                      ...
                      <p className="text-[9.5px] text-gray-500 mt-0.5">
                        Adiciona atributos <code>defer</code> ou <code>async</code> aos scripts, evitando o bloqueio inicial da árvore DOM.
                      </p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-start gap-2.5 p-2.5 bg-[#05080E]/40 border border-slate-850/80 rounded-xl cursor-pointer hover:bg-slate-900/50 transition">
                    ...
                    <div className="text-[11px] leading-snug">
                      ...
                      <p className="text-[9.5px] text-gray-500 mt-0.5">
                        Injeta os estilos essenciais de renderização na tag <code>&lt;style&gt;</code> para acionar o FCP instantaneamente.
                      </p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-start gap-2.5 p-2.5 bg-[#05080E]/40 border border-slate-850/80 rounded-xl cursor-pointer hover:bg-slate-900/50 transition">
                    ...
                    <div className="text-[11px] leading-snug">
                      ...
                      <p className="text-[9.5px] text-gray-500 mt-0.5">
                        Utiliza conexões antecipadas <code>preconnect</code> e carrega Google Fonts fora do fluxo crítico de LCP.
                      </p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-start gap-2.5 p-2.5 bg-[#05080E]/40 border border-slate-850/80 rounded-xl cursor-pointer hover:bg-slate-900/50 transition">
                    ...
                    <div className="text-[11px] leading-snug">
                      ...
                      <p className="text-[9.5px] text-gray-500 mt-0.5">
                        Define cabeçalhos <code>Cache-Control: public, max-age=31536000, immutable</code> para acelerar visitas repetidas ao evitar downloads duplicados.
                      </p>
                    </div>
                  </label>
                </div>
