              ...
              <AnimatePresence>
                {activeDropdown === "sistemas" && (
                  ...
                  >
                    ...
                    {renderDropdownItem("chatbots", "Criador de Chatbots", "Criação de chatbots inteligentes de WhatsApp e websites", <MessageSquare className="h-4 w-4 text-blue-400 pointer-events-none" />)}
              ...
              <div className="p-4 space-y-6 md:space-y-0 md:grid md:grid-cols-3 md:gap-6 max-w-7xl mx-auto">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 gap-1">
                    ...
                    {renderMobileNavItem("chatbots", "Criador de Chatbots", "Criação de chatbots inteligentes WhatsApp e websites", <MessageSquare className="h-3.8 w-3.8 text-blue-400" />)}
