  ...
  const renderBreadcrumbs = () => {
    ...
    return (
      <motion.nav 
        ...
        className="flex flex-wrap items-center gap-1.5 md:gap-2 text-[10px] md:text-xs text-slate-500 font-mono mb-6 bg-slate-900/35 border border-gray-800/40 py-1.5 px-2.5 sm:px-3.5 rounded-xl w-full sm:w-fit max-w-full overflow-hidden" 
