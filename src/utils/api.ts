...
export function getApiUrl(path: string): string {
  ...
  // If we are in local development or directly on the Cloud Run container runner,
  // relative paths should be used. For custom external domains (like korenexus.com.br)
  // or other static hosting (GitHub Pages, Vercel, etc.), absolute URLs must be used.
  const isRelativeAllowed = isCloudRun || isLocalhost;
